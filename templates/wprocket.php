  ...
  <div class="flex-1 bg-white px-6 py-8 max-w-[1230px]">
    ...
    <div class="relative mt-7 pl-10 pr-[25%] py-6 bg-emerald-50">
      ...
      <h2 class="text-2xl font-semibold text-emerald-400 mb-5">
        WP Rocket is now activated and already working for you.<br>
        Your website should be loading faster now!
      </h2>
      <p class="mb-7">
        To guarantee fast websites, WP Rocket automatically applies 80% of web performance best practices.<br>
      ...
      <a href="#" class="block absolute top-6 right-6">
