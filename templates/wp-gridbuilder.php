...
<div class="flex items-center bg-white border-b px-12">
  ...
  <code class="font-thin text-slate-500 rounded bg-slate-100 px-2">v1.6.3</code>
  
  <!-- Top Menu -->
  <nav class="flex ml-auto">
    <a href="#" class="flex items-center px-4 py-7 text-blue-600 border-b-2 border-blue-600">
    ...
    <a href="#" class="flex items-center px-4 py-7 text-slate-600">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
