...
<div class="p-4 flex">
  ...
  <div class="flex flex-col w-[225px]">
    ...
    <nav class="flex-auto">
      ...
      <!-- Navigation Item -->
      <a href="admin.php?page=tailwp-wprocket&tab=dashboard" class="group flex items-center px-5 py-4 hover:bg-white border-t border-l-transparent border-l-2 hover:border-l-orange-600 hover:text-orange-600">
        <div class="flex-auto">
      ...
      <a href="admin.php?page=tailwp-wprocket&tab=cache" class="flex iitems px-5 py-4 border-t border-b border-l-2 border-l-orange-600 bg-white">
        <div class="flex-auto">
