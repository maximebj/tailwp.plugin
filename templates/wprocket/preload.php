...
<div class="p-4 flex">
  ...
  <div class="flex flex-col w-[225px]">
    ...
    <nav class="flex-auto">
      ...
      <a href="admin.php?page=tailwp-wprocket&tab=preload" class="flex px-5 py-4 border-b border-l-2 border-l-orange-600 bg-white">
        <div class="flex-auto">
          <p class="text-orange-600 uppercase font-bold">Preload</p>
  ...
  <div class="flex-1 bg-white px-6 py-8 max-w-[960px]">
    ...
    <div class="flex relative items-center pb-6 border-b after:w-12 after:content-empty after:block after:absolute after:-bottom-[1px] after:border-b-2 after:border-b-orange-600">
      ...
      <h2 class="flex-auto font-medium text-2xl">Preload</h2>
    ...
    <h3 class="flex mt-12 pb-2 border-b">
      <span class="text-base flex-auto font-semibold text-orange-600">Preload Cache</span>
    ...
    <!-- Description -->
    <p class="text-gray-500 text-sm mt-3">When you enable preloading WP Rocket will generate the cache starting with the links on your homepage followed by the sitemaps you specify. Preloading is automatically triggered when you add or update content and can also be manually triggered from the admin bar or from the  <a href="#" class="underline">WP Rocket Dashboard</a></p>

    <!-- Field Container -->
    <div class="bg-gray-50 border rounded mt-4 p-4">
      <input type="checkbox" id="preload">
      <label for="preload" class="font-semibold text-sm">Activate Preloading</label>
      <hr class="my-4">
      <div class="pl-8">
        <input type="checkbox" id="sitemap-preload">
        <label for="sitemap-preload" class="font-semibold text-sm">Activate SiteMap-based cache preloading</label>
      </div>
    </div>

    <!-- Section Title -->
    <h3 class="flex mt-12 pb-2 border-b">
      <span class="text-base flex-auto font-semibold text-orange-600">Preload links</span>
    ...
    <!-- Description -->
    <p class="text-gray-500 text-sm mt-3">Link preloading improves the perceived load time by downloading a page when a user hovers over the link. <a href="#">More info</a></p>

    <!-- Field Container -->
    <div class="bg-gray-50 border rounded mt-4 p-4">
      <input type="checkbox" id="missing-dimension">
      <label for="missing-dimension" class="font-semibold text-sm">Enable links preloading</label>
    </div>

    <!-- Section Title -->
    <h3 class="flex mt-12 pb-2 border-b">
      <span class="text-base flex-auto font-semibold text-orange-600">Prefetch DNS requests</span>
      <a href="#" class="group flex items-center text-cyan-500 hover:text-orange-600 pr-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" />
        </svg>
    ...
    <!-- Description -->
    <p class="text-gray-500 text-sm mt-3">DNS prefetching can make external files load faster, especially on mobile networks.</p>

    <!-- Field Container -->
    <div class="bg-gray-50 border rounded mt-4 p-4">
      <label for="prefetch-urls" class="font-semibold text-sm">URLs to prefetch</label>
      <p class="mt-2 text-gray-500">Specify external hosts to be prefetched (no <code>http:</code>, one per line)</p>

      <textarea id="prefetch-urls" rows="4" placeholder="//example.com" class="mt-2 w-full border-2 p-2 border-gray-400 text-sm"></textarea>

    </div>

    <!-- Section Title -->
    <h3 class="flex mt-12 pb-2 border-b">
      <span class="text-base flex-auto font-semibold text-orange-600">Preload Fonts</span>
      <a href="#" class="group flex items-center text-cyan-500 hover:text-orange-600 pr-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" />
        </svg>
    ...
    <!-- Description -->
    <p class="text-gray-500 text-sm mt-3">Improves performance by helping browsers discover fonts in CSS files. <a href="#" class="underline">More info</a></p>

    <!-- Field Container -->
    <div class="bg-gray-50 border rounded mt-4 p-4">
      <label for="excluded-images" class="font-semibold text-sm">Fonts to preload</label>
      <p class="mt-2 text-gray-500">Specify urls of the font files to be preloaded (one per line). Fonts must be hosted on your own domain, or the domain you have specified on the CDN tab.</p>

      <textarea id="excluded-images" rows="4" placeholder="/wp-content/themes/your-theme/assets/fonts/font-file.woff" class="mt-2 w-full border-2 p-2 border-gray-400 text-sm"></textarea>
  ...
  <div class="w-[290px] px-4 py-6">
    ...
    <div class="bg-emerald-50 p-4 mb-6">
      ...
      <p class="mt-2 text-sm text-gray-500">Use a private browser to check your website's speed and visual appearance.</p>
    </div>
