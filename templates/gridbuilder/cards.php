...
<div class="flex items-center bg-white border-b px-12">
  ...
  <nav class="flex ml-auto">
    ...
    <a href="admin.php?page=tailwp-gridbuilder&tab=cards" class="flex items-center px-4 py-7 text-blue-600 border-b-2 border-blue-600">
      <!-- Cards Icon -->
...
<div class="mx-auto px-12 mt-12">
  ...
  <div class="bg-white p-14 shadow-md rounded-md">
    ...
    <div class="flex mb-4">
      <h2 class="text-2xl tracking-wide font-bold">All Cards</h2>
      
      <!-- Icon Button -->
      <a href="#" class="flex items-center p-3 ml-auto bg-emerald-400 text-white rounded uppercase shadow">
        <!-- Cards Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
          <path d="M9 2a2 2 0 00-2 2v8a2 2 0 002 2h6a2 2 0 002-2V6.414A2 2 0 0016.414 5L14 2.586A2 2 0 0012.586 2H9z" />
          <path d="M3 8a2 2 0 012-2v10h8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z" />
        </svg>
        <span class="flex-auto text-sm font-semibold">Create a Card</span>
      </a>
    </div>
    ...
    <p class="text-right mt-3 text-gray-500">12 items</p>
    ...
    <!-- Card Container -->
    <div class="grid grid-cols-3 p-8 bg-slate-100 gap-4">
      ...
      <div>
        <div class="flex bg-white p-3 rounded">
          ...
          <div class="ml-auto flex text-slate-600">
            <a href="#" class="px-1">
              <!-- Star Icon -->
        ...
        <!-- Card Content -->
        <div class="bg-neutral-200 p-20 text-center rounded-xl">
          <!-- Image Icon -->
    ...
    <div class="flex mt-10">
      ...
      <!-- Pagination Menu -->
      <ul class="flex ml-8 font-semibold">
        <li class="px-3 leading-[36px] ml-2 bg-blue-600 rounded text-white cursor-pointer">1</li>
        <li class="px-3 leading-[36px] ml-2 bg-slate-200 rounded text-gray-900 cursor-pointer">2</li>
        <li class="px-3 leading-[36px] ml-2 bg-slate-200 rounded text-gray-900 cursor-pointer">3</li>
        <li class="px-3 leading-[36px] ml-2 bg-slate-200 rounded text-gray-900 cursor-pointer uppercase">Next</li>
      </ul>
    </div>
