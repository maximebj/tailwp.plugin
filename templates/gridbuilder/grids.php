...
<div class="flex items-center bg-white border-b px-12">
  ...
  <nav class="flex ml-auto">
    ...
    <a href="admin.php?page=tailwp-gridbuilder&tab=grids" class="flex items-center px-4 py-7 text-blue-600 border-b-2 border-blue-600">
      <!-- Grid+ Icon -->
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
  ...
  <div class="bg-white p-14 shadow-md rounded-md">
    ...
    <div class="flex mb-4">
      ...
      <a href="#" class="flex items-center p-3 ml-auto bg-emerald-400 text-white rounded uppercase shadow">
        ...
        <span class="flex-auto text-sm font-semibold">Create a grid</span>
      </a>
    </div>
    ...
    <p class="text-right mt-3 text-gray-500">3 items</p>
    ...
    <ul class="text-slate-500 font-semibold text-sm mt-6">
      ...
      <li class="flex items-center rounded even:bg-slate-100">
        ...
        <div class="px-2 py-3 flex-1">Blog Grid</div>
        <div class="px-2 py-3 flex-1">Post Type</div>
        <div class="px-2 py-3 flex-1">[wpgb_grid id="1"]</div>
      ...
      <li class="flex items-center rounded even:bg-slate-100">
        ...
        <div class="px-2 py-3 flex-1">Portfolio Grid</div>
        <div class="px-2 py-3 flex-1">Post Type</div>
        <div class="px-2 py-3 flex-1">[wpgb_grid id="2"]</div>
      ...
      <li class="flex items-center rounded even:bg-slate-100">
        ...
        <div class="px-2 py-3 flex-1">Products Grid</div>
        <div class="px-2 py-3 flex-1">Post Type</div>
        <div class="px-2 py-3 flex-1">[wpgb_grid id="3"]</div>
